			...
			<div class="content">
				...
				<div id="content_body">
					...
					<div style="padding:5px; margin-bottom:2px; background:#E5E5E5;">
						...
						<div style="float:left; width:600px;"><b>Testimonial</b></div>
					...
					<ul id="slide_sort">
						...
						$_qdb = db_query("SELECT * FROM ".$whoamis." WHERE status <> 'archive' ORDER BY date_time DESC");
							...
							<li id="listItem_<? pv($qdb[id]) ?>">
								...
								<div class="handle" style="margin-bottom:2px;">
									...
									<table width="100%" border=0 cellspacing=1 cellpadding=0 style="text-align:left;">
										<tr>
											<td style="width:600px; <?= $color ?>"><a class="pblock" href="<?= $whoamis ?>-update.php?id=<? pv($qdb['id']) ?>" title="" style="text-decoration:none;"><?= $qdb['testimonial'] ?>&nbsp;</a></td>
